...
const AttrTwo = () => {
  return (
    <div className='relative flex-1'>
      <img src="/images/desktop/image-photography.jpg" className='max-sm:hidden' width="100%" alt="" />
      <img src="/images/mobile/image-photography.jpg" className='sm:hidden' width="100%" alt="" />
